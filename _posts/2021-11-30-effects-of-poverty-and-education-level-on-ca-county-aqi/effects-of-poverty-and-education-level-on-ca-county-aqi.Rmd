...
Since the Not Completed High School level is the most significant (since it has the lowest p-value), let's just focus on that education level for the rest of our analysis.
...
ggplot(aqi_education_poverty_avg_aqi, aes(x = poverty_perc, y = nchs)) +
  ...
  labs(x = "Poverty Percentage (%)",
       ...
       title = "Relationship between Not Completing High School and Poverty",
       subtitle = "2015-2019")
...
- An R squared value of 0.1142 means that 11.42% of the variation in mean AQI of a county in CA is explained by the percentage of people not completing high school and the poverty percentage of the county.
